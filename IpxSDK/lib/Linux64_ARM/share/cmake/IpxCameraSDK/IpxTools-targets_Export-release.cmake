...
set_target_properties(IpxDemosaicing PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/Linux64_ARM/libIpxDemosaicing.so.3.3.0.51"
  IMPORTED_SONAME_RELEASE "libIpxDemosaicing.so.3"
  )

list(APPEND _IMPORT_CHECK_TARGETS IpxDemosaicing )
list(APPEND _IMPORT_CHECK_FILES_FOR_IpxDemosaicing "${_IMPORT_PREFIX}/lib/Linux64_ARM/libIpxDemosaicing.so.3.3.0.51" )
...
set_target_properties(IpxMisc PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/Linux64_ARM/libIpxMisc.so.3.3.0.51"
  IMPORTED_SONAME_RELEASE "libIpxMisc.so.3"
  )

list(APPEND _IMPORT_CHECK_TARGETS IpxMisc )
list(APPEND _IMPORT_CHECK_FILES_FOR_IpxMisc "${_IMPORT_PREFIX}/lib/Linux64_ARM/libIpxMisc.so.3.3.0.51" )
...
set_target_properties(IpxImageApi PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/Linux64_ARM/libIpxImageApi.so.3.3.0.51"
  IMPORTED_SONAME_RELEASE "libIpxImageApi.so.3"
  )

list(APPEND _IMPORT_CHECK_TARGETS IpxImageApi )
list(APPEND _IMPORT_CHECK_FILES_FOR_IpxImageApi "${_IMPORT_PREFIX}/lib/Linux64_ARM/libIpxImageApi.so.3.3.0.51" )
...
set_target_properties(IpxImageConverter PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/Linux64_ARM/libIpxImageConverter.so.3.3.0.51"
  IMPORTED_SONAME_RELEASE "libIpxImageConverter.so.3"
  )

list(APPEND _IMPORT_CHECK_TARGETS IpxImageConverter )
list(APPEND _IMPORT_CHECK_FILES_FOR_IpxImageConverter "${_IMPORT_PREFIX}/lib/Linux64_ARM/libIpxImageConverter.so.3.3.0.51" )
...
set_target_properties(IpxImageUnpacker PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/Linux64_ARM/libIpxImageUnpacker.so.3.3.0.51"
  IMPORTED_SONAME_RELEASE "libIpxImageUnpacker.so.3"
  )

list(APPEND _IMPORT_CHECK_TARGETS IpxImageUnpacker )
list(APPEND _IMPORT_CHECK_FILES_FOR_IpxImageUnpacker "${_IMPORT_PREFIX}/lib/Linux64_ARM/libIpxImageUnpacker.so.3.3.0.51" )
...
set_target_properties(IpxImageSerializer PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/Linux64_ARM/libIpxImageSerializer.so.3.3.0.51"
  IMPORTED_SONAME_RELEASE "libIpxImageSerializer.so.3"
  )

list(APPEND _IMPORT_CHECK_TARGETS IpxImageSerializer )
list(APPEND _IMPORT_CHECK_FILES_FOR_IpxImageSerializer "${_IMPORT_PREFIX}/lib/Linux64_ARM/libIpxImageSerializer.so.3.3.0.51" )
...
set_target_properties(IpxDisplayQt PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/Linux64_ARM/libIpxDisplayQt.so.3.3.0.51"
  IMPORTED_SONAME_RELEASE "libIpxDisplayQt.so.3"
  )

list(APPEND _IMPORT_CHECK_TARGETS IpxDisplayQt )
list(APPEND _IMPORT_CHECK_FILES_FOR_IpxDisplayQt "${_IMPORT_PREFIX}/lib/Linux64_ARM/libIpxDisplayQt.so.3.3.0.51" )
