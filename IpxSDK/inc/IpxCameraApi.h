	...
	*/
	...
	public:
		...
		*/
		...
		/*!
        \param[in] aEventSink pointer to Paramet Event Sink
		\return returns the Error code:
...
namespace IpxCam
{
	...
	*/
	...
	{
        USB3Vision   = 1, /*!< Enum value USB3Vision. */
        GigEVision  = 2, /*!< Enum value GigEVision. */
        CameraLink  = 3, /*!< Enum value CameraLink. */
        CoaxPress   = 4, /*!< Enum value CoaxPress. */
        HdSdi       = 5, /*!< Enum value HdSdi. */
	...
	*/
	...
	public:
		...
		*/		
		...
		/*!
		\brief Creates the Device object from configuraion file
		...
		*/
		...
		/*!
		\brief Registers the GenTL CTI library
	...
	*/
    ...
    public:
		...
		*/		
        ...
        //! TThis method retrieves the DeviceInfo object for the first device available on this Interface.
		/*! 
		...
		*/		
		...
		/*! 
		\brief Returns the user readable description of the interface
		...
		*/		
		...
		/*! 
		\brief Returns the Interface Type (Transport Layer Technology) of this interface
		...
		*/		
		...
		/*! 
		\brief Returns the pointer to the string with the version of the interface driver
	...
	*\brief DeviceInfo class provides the information about the device
	\details The DeviceInfo class can be used to retrieve the information about the device, 
	  and to create the Device object by IpxCam_CreateDevice() call
	*/
	class DeviceInfo
	{
    public:
        ...
        */
		...
		/*! 
		\brief Returns the Interface pointer for the device, associated with the DeviceInfo object
		...
		*/		
		...
		/*! 
		\return returns the user readable name of the Camera device
		*/		
        virtual const char* GetDisplayName() = 0;
		...
		*/		
		...
		/*!
		\brief Set IP address to GEV camera.
		\param[in] addr IP Address to set
		\param[in] netmask IP Address subnet mask
    ...
    */
	...
	public:
		...
		*/
		...
		/*!
		\return retrurns the number of the data streams
		*/
		...
		*/		
		...
		/*!
		\param[in] id pointer to the string reresenting the stream identifier
		\return returns the pointer to the Stream object
		*/
		...
		*/		
		...
		\param[in] flags flag
        \param[in] pCallback pointer to the event Callback
		\return returns ErrorCode   
		*/	
	...
	*/
	...
	public:
		...
		*/		
		...
		/*! 
		\brief This method removes the specified announced buffer from the acquisition engine's queue 
	...
	*/
	...
	public:
        ...
        /*!
        \brief Destructor. Destroys the Buffer object and all its descendants.
        */
        virtual ~Buffer(){}
