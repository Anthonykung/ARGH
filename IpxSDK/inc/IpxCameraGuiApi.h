...
namespace IpxGui 
{
	...
	*/
    ...
    public:
        ...
        */
        ...
        \brief The array consists of string values separated by token. Just save this data somethere if you want to restore state later.
        */
		...
		*/
		...
		/*!
		\brief retrives the polling time. Polling should be enabled by enablePolling() function
		...
		*/
		...
		/*
		\brief retrives current polling state set by enablePolling() function
	...
	*/		
    ...
    //! This method destroys the IIpxGenParamTreeView object previously created.
	/*! 
